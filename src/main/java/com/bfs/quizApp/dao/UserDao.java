...
public class UserDao {
    ...
    public void createNewUser(String emailAddress, String password, String firstName, String lastName) {
        String query = "INSERT INTO user (firstName, lastName, email, password) " +
                "values (?, ?, ?, ?)";
        jdbcTemplate.update(query, firstName, lastName, emailAddress, password);
    }
